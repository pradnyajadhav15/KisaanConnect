...
export default function ProductDetails({ product, onAddToCart, onBack }) {
  ...
  return (
    <div className="product-details">
      <button className="back-button" onClick={onBack}>&larr; Back to Products</button>
      ...
      <div className="product-details-container">
        ...
        <div className="product-details-info">
          ...
          <p className="product-price">{'Rs. ' + product.price + ' per ' + product.unit}</p>
          ...
          {inStock && (
            <div className="quantity-selector">
              ...
              <div className="quantity-input-group">
                <button className="quantity-button" onClick={handleDecrement} disabled={quantity <= 1} aria-label="Decrease quantity">-</button>
                <input
                  type="number"
                  value={quantity}
                  ...
                  aria-label="Quantity"
                />
                <button className="quantity-button" onClick={handleIncrement} disabled={quantity >= maxQty} aria-label="Increase quantity">+</button>
              </div>
            </div>
          )}
          ...
          <button className="add-to-cart-large" onClick={handleAddToCart} disabled={!inStock}>
